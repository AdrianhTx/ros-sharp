# Version 1.7.0 Unity Package Manager Support Fork #

This is a fork of the [original ROS# repository by Siemens](https://github.com/siemens/ros-sharp) that adds Unity Package Manager support to the original v1.7.0 release.
...
```https://github.com/telexistence-inc/ros-sharp.git?path=/Unity3D/Assets/RosSharp#1.7.0-upm```
